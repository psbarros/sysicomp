            ...
            <?php $form = ActiveForm::begin(['id' => 'form-signup']); ?>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row" id="divSecretaria" style="margin-left: 0px; margin-right: 0px; <?php if(!$model->secretaria) echo 'display:none';?>">
                        ...
                        <div class="row" id="divProfessor" style="margin-left: 0px; margin-right: 0px; <?php if(!$model->professor) echo 'display:none';?>">
                            <?= $form->field($model, 'titulacao', ['options' => ['class' => 'col-md-6 col-left']])->dropDownList(['Graduado' => 'Graduado', 'Especialista' => 'Especialista', 'Mestre' => 'Mestre', 'Doutor' => 'Doutor'], ['prompt' => 'Selecione a titulação...']) ?>
                            <?= $form->field($model, 'regime', ['options' => ['class' => 'col-md-6 col-right']])->dropDownList(['20h' => '20h', '40h' => '40h', 'DE' => 'DE'], ['prompt' => 'Selecione o regime de dedicação...']) ?>
                            <?= $form->field($model, 'classe', ['options' => ['class' => 'col-md-6 col-left']])->textInput(['maxlength' => true])->label("<b>Classe:</b>") ?>
                            <?= $form->field($model, 'nivel', ['options' => ['class' => 'col-md-6 col-right']])->textInput(['maxlength' => true])->label("<b>Nível:</b>") ?>
                            <?= $form->field($model, 'idLattes', ['options' => ['class' => 'col-md-4 col-left']])->textInput(['maxlength' => true])->label("<b>ID Lattes:</b>") ?>
                            <?= $form->field($model, 'idRH', ['options' => ['class' => 'col-md-4']])->textInput(['maxlength' => true])->label("<b>Contrato RH:</b>") ?>
                            <?= $form->field($model, 'alias', ['options' => ['class' => 'col-md-4 col-right']])->textInput(['maxlength' => true])->label("<b>Tag da página do professor:</b>") ?>
                        </div>
                    </div>
                </div>
